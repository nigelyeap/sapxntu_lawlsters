...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React74 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState6 = React74.useState, useEffect16 = React74.useEffect, useLayoutEffect = React74.useLayoutEffect, useDebugValue = React74.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React74 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef11 = React74.useRef, useEffect16 = React74.useEffect, useMemo12 = React74.useMemo, useDebugValue = React74.useDebugValue;
...
var ChartStore = class {
  constructor(value) {
    ...
    __publicField(this, "update", (updater) => {
...
function ChartsLocalizationProvider(inProps) {
  ...
  } = inProps, other = _objectWithoutPropertiesLoose(inProps, _excluded4);
  const {
  ...
  return (0, import_jsx_runtime4.jsx)(ChartsLocalizationContext.Provider, {
    value: contextValue,
    children
  });
}
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(React25.Fragment, {
...
// node_modules/@mui/x-charts/esm/ChartsXAxis/ChartsSingleXAxis.js
var React31 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/esm/hooks/useIsHydrated.js
var React27 = __toESM(require_react(), 1);
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React27.useState(typeof window !== "undefined" || false);
  React27.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
// node_modules/@mui/x-charts/esm/ChartsXAxis/useAxisProps.js
var _excluded10 = ["scale", "tickNumber", "reverse"];
var useAxisProps = (inProps) => {
  const {
    xAxis,
    xAxisIds
  } = useXAxes();
  ...
  return (0, import_jsx_runtime11.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime11.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime11.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime11.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
...
// node_modules/@mui/x-charts/esm/ChartsXAxis/ChartsGroupedXAxis.js
    ...
    children: [!disableLine && (0, import_jsx_runtime12.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime12.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime12.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime12.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
function ChartsXAxis(inProps) {
  ...
  if ("groups" in axis && Array.isArray(axis.groups)) {
    return (0, import_jsx_runtime13.jsx)(ChartsGroupedXAxis, _extends({}, inProps));
  }
  return (0, import_jsx_runtime13.jsx)(ChartsSingleXAxis, _extends({}, inProps));
}
...
// node_modules/@mui/x-charts/esm/ChartsYAxis/ChartsSingleYAxis.js
...
// node_modules/@mui/x-charts/esm/ChartsYAxis/useAxisProps.js
var _excluded11 = ["scale", "tickNumber", "reverse"];
var useAxisProps2 = (inProps) => {
  const {
    yAxis,
    yAxisIds
  } = useYAxes();
...
function ChartsSingleYAxis(inProps) {
  ...
  return (0, import_jsx_runtime14.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime14.jsx)(Line, _extends({
      ...
      y2: top + height,
      className: classes.line
    }, lineProps)), yTicks.map((item, index2) => {
      const {
        offset: tickOffset,
        labelOffset,
        value
      ...
      return (0, import_jsx_runtime14.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime14.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime14.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
      }, index2);
    }), label && isHydrated && (0, import_jsx_runtime14.jsx)("g", {
      className: classes.label,
...
// node_modules/@mui/x-charts/esm/ChartsYAxis/ChartsGroupedYAxis.js
...
function ChartsYAxis(inProps) {
  ...
  if ("groups" in axis && Array.isArray(axis.groups)) {
    return (0, import_jsx_runtime16.jsx)(ChartsGroupedYAxis, _extends({}, inProps));
  }
  return (0, import_jsx_runtime16.jsx)(ChartsSingleYAxis, _extends({}, inProps));
}
...
function ChartsTooltipContainer(inProps) {
  ...
  return (0, import_jsx_runtime22.jsx)(NoSsr_default, {
    children: isOpen && (0, import_jsx_runtime22.jsx)(ChartsTooltipRoot, _extends({
...
function ChartsTooltip(props) {
  ...
  const classes = useUtilityClasses6(propClasses);
  return (0, import_jsx_runtime23.jsx)(ChartsTooltipContainer, _extends({}, props, {
    classes: propClasses,
    children: trigger === "axis" ? (0, import_jsx_runtime23.jsx)(ChartsAxisTooltipContent, {
      classes
    }) : (0, import_jsx_runtime23.jsx)(ChartsItemTooltipContent, {
      classes
    })
  }));
}
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    return (0, import_jsx_runtime24.jsx)(Component, _extends({}, outProps, {
      ref
    }));
  }
...
var ChartsLabel = consumeThemeProps("MuiChartsLabel", {
  ...
  return (0, import_jsx_runtime25.jsx)("span", _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    children
...
var ChartsLegend = consumeSlots("MuiChartsLegend", "legend", {
  ...
  return (0, import_jsx_runtime26.jsx)(RootElement, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime26.jsx)("li", {
        ...
        "data-series": item.id,
        children: (0, import_jsx_runtime26.jsxs)(Element, {
          ...
          children: [(0, import_jsx_runtime26.jsx)(ChartsLabelMark, {
            ...
            color: item.color,
            type: item.markType
          }), (0, import_jsx_runtime26.jsx)(ChartsLabel, {
...
var ChartsLabelGradient = consumeThemeProps("MuiChartsLabelGradient", {
  ...
  const isRtl = useRtl();
  return (0, import_jsx_runtime27.jsx)(Root2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ...
    children: (0, import_jsx_runtime27.jsx)("div", {
      className: classes == null ? void 0 : classes.mask,
      children: (0, import_jsx_runtime27.jsx)("svg", {
        viewBox: "0 0 24 24",
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  const minComponent = (0, import_jsx_runtime28.jsx)("li", {
    className: classes == null ? void 0 : classes.minLabel,
    children: (0, import_jsx_runtime28.jsx)(ChartsLabel, {
      className: classes == null ? void 0 : classes.label,
      children: minText
    })
  });
  const maxComponent = (0, import_jsx_runtime28.jsx)("li", {
  ...
  return (0, import_jsx_runtime28.jsxs)(RootElement2, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime28.jsx)("li", {
      className: classes == null ? void 0 : classes.gradient,
      children: (0, import_jsx_runtime28.jsx)(ChartsLabelGradient, {
        direction,
...
var PiecewiseColorLegend = consumeThemeProps("MuiPiecewiseColorLegend", {
  ...
  return (0, import_jsx_runtime29.jsx)(RootElement3, _extends({
    className: clsx_default(classes == null ? void 0 : classes.root, className),
    ref
  }, other, {
    ownerState: props,
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime29.jsx)("li", {
        children: (0, import_jsx_runtime29.jsxs)(Element, {
          role: onItemClick ? "button" : void 0,
          type: onItemClick ? "button" : void 0,
          onClick: (
            // @ts-ignore onClick is only attached to a button
          ...
          children: [isTextBefore && (0, import_jsx_runtime29.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          }), (0, import_jsx_runtime29.jsx)(ChartsLabelMark, {
            className: classes == null ? void 0 : classes.mark,
            type: markType,
            color: color2
          }), isTextAfter && (0, import_jsx_runtime29.jsx)(ChartsLabel, {
            className: classes == null ? void 0 : classes.label,
            children: label
          })]
        })
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'extremes'
   */
  labelPosition: import_prop_types19.default.oneOf(["start", "end", "extremes"]),
  /**
   * The type of the mark.
   * @default 'square'
   */
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime30.jsxs)(React53.Fragment, {
      children: [isBandScaleY && yScale(value) !== void 0 && (0, import_jsx_runtime30.jsx)(ChartsAxisHighlightPath, {
        d: `M ${left} ${yScale(value) - (yScale.step() - yScale.bandwidth()) / 2} l 0 ${yScale.step()} l ${width} 0 l 0 ${-yScale.step()} Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime30.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime31.jsxs)(React54.Fragment, {
      children: [isBandScaleX && xScale(value) !== void 0 && (0, import_jsx_runtime31.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React55.Fragment, {
    children: [xAxisHighlight && xAxisHighlight !== "none" && (0, import_jsx_runtime32.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && yAxisHighlight !== "none" && (0, import_jsx_runtime32.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(React57.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
      var _a;
      return (0, import_jsx_runtime34.jsx)(GridLine, {
        y1: start,
        y2: end,
        x1: offset,
        x2: offset,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime36.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime36.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime36.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime39.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime39.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded26 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend", "showToolbar"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React63.useMemo(() => [{
    id: DEFAULT_X_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
  ...
  const defaultBandYAxis = React63.useMemo(() => [{
    id: DEFAULT_Y_AXIS_KEY,
    scaleType: "band",
    data: Array.from({
      length: Math.max(...series.map((s2) => (s2.data ?? dataset ?? []).length))
  ...
  const seriesWithDefault = React63.useMemo(() => series.map((s2) => _extends({
    type: "bar"
  }, s2, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React63.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React63.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime41.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime41.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime42.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime42.jsxs)(React67.Fragment, {
...
var ChartsSurface = React71.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsxs)(ChartsSurfaceStyles, _extends({
    ...
    children: [title && (0, import_jsx_runtime46.jsx)("title", {
      ...
      children: desc
    }), (0, import_jsx_runtime46.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
if (true)
...
var _excluded29 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "highlightedAxis", "onHighlightedAxisChange", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText", "slots", "slotProps", "experimentalFeatures"];
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types25.default.bool,
  /**
   * The direction of the legend.
   * @default 'horizontal'
   */
  legendDirection: import_prop_types25.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types25.default.shape({
    horizontal: import_prop_types25.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types25.default.oneOf(["bottom", "middle", "top"])
  }),
...
var BarChart = React73.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime48.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime48.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime48.jsx)(Toolbar, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime48.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime48.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime48.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime48.jsxs)("g", _extends({}, clipPathGroupProps, {
        ...
        })), (0, import_jsx_runtime48.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime48.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime48.jsx)(Tooltip, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.tooltip))]
    }))
  }));
});
if (true)
...
true ? BarChart.propTypes = {
   ...
   */
  highlightedAxis: import_prop_types26.default.arrayOf(import_prop_types26.default.shape({
    axisId: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]).isRequired,
   ...
   */
  onHighlightedAxisChange: import_prop_types26.default.func,
  /**
   * Callback fired when a bar item is clicked.
   * @param {React.MouseEvent<SVGElement, MouseEvent>} event The event source of the callback.
   * @param {BarItemIdentifier} barItemIdentifier The bar item identifier.
   ...
   * @default false
   */
  showToolbar: import_prop_types26.default.bool,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
  ...
  xAxis: import_prop_types26.default.arrayOf(import_prop_types26.default.oneOfType([import_prop_types26.default.shape({
    ...
    groups: import_prop_types26.default.arrayOf(import_prop_types26.default.shape({
      getValue: import_prop_types26.default.func.isRequired,
    ...
    constant: import_prop_types26.default.number,
    data: import_prop_types26.default.array,
    dataKey: import_prop_types26.default.string,
    disableLine: import_prop_types26.default.bool,
    disableTicks: import_prop_types26.default.bool,
    ...
    position: import_prop_types26.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types26.default.bool,
    scaleType: import_prop_types26.default.oneOf(["symlog"]),
    slotProps: import_prop_types26.default.object,
    slots: import_prop_types26.default.object,
    sx: import_prop_types26.default.oneOfType([import_prop_types26.default.arrayOf(import_prop_types26.default.oneOfType([import_prop_types26.default.func, import_prop_types26.default.object, import_prop_types26.default.bool])), import_prop_types26.default.func, import_prop_types26.default.object]),
    tickInterval: import_prop_types26.default.oneOfType([import_prop_types26.default.oneOf(["auto"]), import_prop_types26.default.array, import_prop_types26.default.func]),
